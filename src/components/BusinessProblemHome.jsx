          ...
          <div className="business-prob-cards">
            <div className="prob-card" id="prob-card-1">
              <div className="card-head">
                ...
                <div className="card-head-text">Modern & Responsive Design</div>
              </div>

              <div className="card-content">
                <p>
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Id,
                  eveniet quas! Laudantium odit similique quam error rerum
              ...
              <div className="card-badge">
                ...
                <div id="card-badge-2">
                  <MDBBadge className="badge badge-color-2">Development</MDBBadge>
                </div>
              </div>
            </div>
            ...
            <div className="prob-card" id="prob-card-2">
              ...
              <div className="card-badge">
                <div id="card-badge-1">
                  <MDBBadge className="badge badge-color-1">Services</MDBBadge>
                </div>
